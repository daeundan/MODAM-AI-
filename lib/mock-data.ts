...
export const MOCK_EXPERTS: Expert[] = [
  {
    ...
    name: "김수현 원장",
    title: "탈모·모발이식 전문의",
    hospital: "모담 탈모클리닉 강남점",
    specialty: "남성형/여성형 탈모, 모발이식 수술",
    rating: 4.8,
    consultFee: "상담 3만원~",
    imageUrl: "/experts/doctor1.png",
  },
  {
    id: "e2",
    name: "이지민 박사",
    title: "피부과 전문의",
    hospital: "제이 피부과 의원",
    specialty: "두피 질환, 원형 탈모, 메디컬 케어",
    rating: 4.7,
    consultFee: "진료비 별도",
    imageUrl: "/experts/doctor2.png",
  },
  {
    id: "e3",
    name: "박철수 수석 디자이너",
    title: "두피 케어 마스터",
    hospital: "헤어모드 청담",
    specialty: "미용실 두피 스케일링, 탈모 커팅 기술",
    rating: 4.9,
    consultFee: "커트 포함 5만원~",
    imageUrl: "/experts/hairdresser.jpeg",
  },
  {
    id: "e4",
    name: "최유리 실장",
    title: "가발·증모 전문가",
    hospital: "스타일 위그 스튜디오",
    specialty: "부분 가발 맞춤, 증모술, 스타일링",
    rating: 4.6,
    consultFee: "1:1 맞춤 상담 무료",
    imageUrl: "/experts/wig_expert.jpeg",
  },
];
